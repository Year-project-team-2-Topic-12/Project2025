...
- 👨‍💻 Язык(и) разработки (ML-часть): [python](https://www.python.org/) (3.13 или под выбранные библиотеки в случае если какие-то будут необходимы, будет уточняться в процессе дизайна и реализации). Бекенд - python, в случае, если в процессе разработки решения будет принято решение о необходимости достаточно сложного пользовательского интерфейса (i.e. streamlit будет не достаточно) + [React.js](https://react.dev/) 
